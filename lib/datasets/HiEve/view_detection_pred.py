...
def main(args):
    ...
    for gt_idx, (vid_key, vid_name) in enumerate(vid_dict.items()):
        ...
        preds = [parsing_hieve_detection(pred_path) for pred_path in pred_paths]
...
def parse_args():
    ...
    pred_dirs = {
        'byte_ablation': '/home/jhc/PycharmProjects/MOT/MOT_study/ConfTrack/results/detector/yolox/HiEve_test/yolox_x_byte_hieve_ablation_custom'
        , 'public': '/home/jhc/Desktop/dataset/open_dataset/HiEve/public_detection_test/test'
    }
